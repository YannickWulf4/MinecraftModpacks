...
craftingTable.removeRecipe(<item:supplementaries:cage>);
craftingTable.removeRecipe(<item:supplementaries:candle_holder>);
craftingTable.removeRecipe(<item:supplementaries:checker_block>);
craftingTable.removeRecipe(<item:supplementaries:checker_slab>);
craftingTable.removeRecipe(<item:supplementaries:checker_vertical_slab>);
craftingTable.removeRecipe(<item:supplementaries:cog_block>);
craftingTable.removeRecipe(<item:supplementaries:copper_lantern>);
craftingTable.removeRecipe(<item:supplementaries:firefly_spawn_egg>);
craftingTable.removeRecipe(<item:supplementaries:flax>);
craftingTable.removeRecipe(<item:supplementaries:flax_seeds>);
craftingTable.removeRecipe(<item:supplementaries:fodder>);
craftingTable.removeRecipe(<item:supplementaries:hanging_sign_twisted>);
craftingTable.removeRecipe(<item:supplementaries:lock_block>);
craftingTable.removeRecipe(<item:supplementaries:magma_cream_block>);
craftingTable.removeRecipe(<item:supplementaries:rope>);
craftingTable.removeRecipe(<item:supplementaries:sign_post_twisted>);
craftingTable.removeRecipe(<item:supplementaries:soul_jar>);
craftingTable.removeRecipe(<item:supplementaries:speaker_block>);
craftingTable.removeRecipe(<item:supplementaries:stone_lamp>);
